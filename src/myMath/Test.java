...
public class Test {
	...
	public static void MonomTest(){
		...
		//derivative
		System.out.println("derivative m1=36.0x^4 ->"+m1.derivative());
		System.out.println("derivative m3= 6.2x ->"+m3.derivative());
		System.out.println("derivative m5=12.0x ->"+m5.derivative());
		...
		m2.add(m5);
		System.out.println("m2=m2+m5=9.1x^2 ->"+m2);
	...
	public static void PolynomTest(){
		...
		Polynom p2=new Polynom("1.0x^5+3x^2");
